...
public class FeedDelayTest extends BaseTestClass {
    ...
    * */
    ...
    public void delayTest(String sourceStartTime, String targetStartTime,
        ...
        feed.withProperty("timeout", "minutes(35)");
        feed.withProperty("parallel", "3");
        ...
        String bundleId = OozieUtil.getLatestBundleID(cluster2OC, feed.getName(), EntityType.FEED);
        ...
        InstanceUtil.waitTillInstanceReachState(cluster2OC, feed.getName(), 0,
